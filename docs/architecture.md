...
State management is exclusively BLoC/Cubit through `flutter_bloc`. UI widgets depend on Cubits and repositories, while services simulate REST calls and contain no UI code.
